...
public enum CatalogItemVisibility {
    ...
    public com.gcorp.service.app.mvflix_movies.catalog.domain.access.Visibility toVisibility() {
        return com.gcorp.service.app.mvflix_movies.catalog.domain.access.Visibility.valueOf(name());
    }
}
